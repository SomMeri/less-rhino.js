...
Media.prototype.eval = function (context) {
    ...
    //return media.evalNested(context); // TypeError: Cannot call method 'pop' of undefined
...
Media.prototype.evalNested = function (context) {
    ...
    //    b and c and d
    //    b and c and e
    this.features = new Value(this.permute(path).map(function (path) { //TypeError: Object [object Object] has no method 'map'
